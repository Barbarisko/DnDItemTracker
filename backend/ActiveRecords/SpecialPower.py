...
class SpecialPower(Object):
    ...
    INSERT_SPECIAL_POWER_STR = "INSERT INTO SPECIAL_POWERS (NAME, CHARGES, USED_CHARGES, DESCRIPTION) VALUES('{}', {}, {}) RETURNING ID;"
    INSERT_CHARACTER_SPECIAL_POWER_STR = "INSERT INTO CHAR_POWERS (CHARACTER_ID, POWER_ID) VALUES({}, {});"

    UPDATE_SPECIAL_POWER_STR = "UPDATE SPECIAL_POWERS SET (NAME, CHARGES, USED_CHARGES, DESCRIPTION) = ('{}', {}, {}) WHERE SPECIAL_POWERS.ID = {};"
